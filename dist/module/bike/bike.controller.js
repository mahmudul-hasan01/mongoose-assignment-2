...
const createBike = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = req.body;
        const result = yield bike_model_1.default.create(data);
        res.json({
...
const getBike = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = req.body;
        const result = yield bike_model_1.default.find(data);
        res.json({
...
const updateBike = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield bike_model_1.default.findByIdAndUpdate(id, updateData);
        res.json({
